  ...
  describe Recognizer do
    ...
    let(:groups) do
      [
        Group.new(
          label: :one,
          recognizer: subject,
          expected_coordinates: { x1: 145, y1: 780, x2: 270, y2: 1290 }
        ),
        Group.new(
          label: :two,
          recognizer: subject,
          expected_coordinates: { x1: 370, y1: 780, x2: 500, y2: 1290 }
        ),
        Group.new(
          label: :three,
          recognizer: subject,
          expected_coordinates: { x1: 595, y1: 780, x2: 720, y2: 1290 }
        ),
        Group.new(
          label: :four,
          recognizer: subject,
          expected_coordinates: { x1: 820, y1: 780, x2: 950, y2: 1290 }
        ),
        Group.new(
          label: :five,
          recognizer: subject,
          expected_coordinates: { x1: 1045, y1: 780, x2: 1170, y2: 1290 }
        )
      ]
    end
    ...
    describe '#configure' do
      before do
        ...
        groups = [
          Group.new(label: :one, recognizer: subject),
          Group.new(label: :two, recognizer: subject, marks_options: %w[X Y Z])
        ]
